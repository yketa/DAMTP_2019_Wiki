...
give
\begin{eqnarray}
\frac{4}{s L v_0} = \frac{\coth\left(\sqrt{\frac{\psi L^2}{4 l v_0}}\right)}{\sqrt{\frac{\psi L^2}{4 l v_0}}} \Leftrightarrow \frac{1}{\Lambda} = \frac{\coth\left(\sqrt{\Phi}\right)}{\sqrt{\Phi}} &\qquad\qquad s > 0, \psi > 0\\
- \frac{4}{s L v_0} = \frac{\cot\left(\sqrt{\frac{|\psi| L^2}{4 l v_0}}\right)}{\sqrt{\frac{|\psi| L^2}{4 l v_0}}} \Leftrightarrow - \frac{1}{\Lambda} = \frac{\cot\left(\sqrt{|\Phi|}\right)}{\sqrt{|\Phi|}} &\qquad\qquad s < 0, \psi < 0
\end{eqnarray}
where we have set
\begin{eqnarray}
\label{Lambda}
\Lambda = \frac{s L v_0}{4}\\
\label{Phi}
\Phi = \frac{\psi L^2}{4 l v_0} = \frac{\Psi}{4 l v_0}
\end{eqnarray}
for convenience, and introduce
\begin{equation}
\Gamma = \frac{\Phi}{\Lambda} = \frac{\psi}{4 s v_0^2} \frac{4 L}{l} = \gamma \frac{4 L}{l}
\label{eqGamma}
\end{equation}
...
\caption{Rescaled sticking term $\Gamma = (4L/l) \, \gamma$ as a function of rescaled biasing parameter $\Lambda = (L v_0/4) \, s$.}
\label{Gamma}
\end{figure}
...
\caption{Rescaled regular part $L \varepsilon(r)$ as a function of rescaled distance $r/L$ for different values of the rescaled biasing parameter $\Lambda = (L v_0/4) \, s$.}
\label{fig:epsilon}
\end{figure}
