...
give
\begin{eqnarray}
\frac{1}{s L v_0} = \frac{\coth\left(\sqrt{\frac{\psi L^2}{2 l v_0}}\right)}{\sqrt{\frac{\psi L^2}{2 l v_0}}} \Leftrightarrow \frac{1}{\Lambda} = \frac{\coth\left(\sqrt{\Psi}\right)}{\sqrt{\Psi}} &\qquad\qquad s > 0, \psi > 0\\
- \frac{1}{s L v_0} = \frac{\cot\left(\sqrt{\frac{|\psi| L^2}{2 l v_0}}\right)}{\sqrt{\frac{|\psi| L^2}{2 l v_0}}} \Leftrightarrow - \frac{1}{\Lambda} = \frac{\cot\left(\sqrt{|\Psi|}\right)}{\sqrt{|\Psi|}} &\qquad\qquad s < 0, \psi < 0
\end{eqnarray}
where we have set
\begin{eqnarray}
\label{Lambda}
\Lambda = s L v_0\\
\label{Phi}
\Psi = \frac{\psi L^2}{2 l v_0} = \frac{\varphi}{2 l v_0}
\end{eqnarray}
